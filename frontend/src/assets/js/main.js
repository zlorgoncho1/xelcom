...
-------------------------------------------------------------------*/
  ...
  new MutationObserver(() => {
    ...
    if (newUrl !== currentUrl) {
      console.log(
        ">> Mutation Observed ! Last : " + currentUrl + " New : " + newUrl
      );
      currentUrl = newUrl;
      main();
    }
  ...
  function detectWidthForSidebar() {
    ...
    const check = () => {
      ...
      if (width < 992)
        document
          .querySelector(".js-dashboard-home-9")
          .classList.add("-is-sidebar-hidden");
      else
        document
          .querySelector(".js-dashboard-home-9")
          .classList.remove("-is-sidebar-hidden");
    };
  ...
  function dashboardSidebarSwitch() {
    ...
    buttons.forEach((el) => {
      el.addEventListener("click", () => {
        ...
        const openMenu = target.querySelector(
          `[data-sidebar-menu-open="${attr}"]`
        );
  ...
  function darkModeSwitch() {
    ...
    button.addEventListener("click", () =>
      App.html.classList.toggle("-dark-mode")
    );
  }

  function hideSidebar() {
    const target = document.querySelector(
      ".js-dashboard-home-9-sidebar-toggle"
    );
    if (!target) return;
  ...
  function shopSlider() {
    ...
    const sliderPaginationItems = document.querySelectorAll(
      ".js-shop-slider .js-slider-pagination > *"
    );

    sliderInstance.on("slideChangeTransitionStart", function () {
      sliderPaginationItems[sliderInstance.activeIndex].classList.add(
        "is-active"
      );
    });
    ...
    for (let i = 0; i < sectionSlider.length; i++) {
      ...
      if (el.hasAttribute("data-pagination")) {
        ...
        if (el.getAttribute("data-pagination"))
          paginationElement = document.querySelector(
